!(function (e, t) {
  ...
  var p = (function (i) {
    ...
    function a(e) {
      var t,
        a = i.call.apply(i, [this].concat(e)) || this;
      return (
        (e = (function (e) {
          if (void 0 === e)
  ...
  var h,
    ...
    v = {
      ...
      on: function () {
        ...
        function o(e) {
          ...
          if (t) {
            ...
            if ((a.indexOf(e) < 0 && a.unshift(e), T(t).is(r))) n.apply(t, a);
            else
              for (var i = T(t).parents(), s = 0; s < i.length; s += 1)
                T(i[s]).is(r) && n.apply(i[s], a);
          }
        }
        function l(e) {
      ...
      trigger: function () {
        for (
          var e = w(), t = arguments.length, a = new Array(t), i = 0;
          i < t;
          i++
        )
          a[i] = arguments[i];
      ...
      is: function (e) {
        ...
        if ("string" == typeof e) {
          ...
          for (t = T(e), a = 0; a < t.length; a += 1) if (t[a] === r) return !0;
          return !1;
        }
        if (e === s) return r === s;
        if (e === i) return r === i;
  ...
  function g(e, t) {
    ...
    var a,
      ...
      n =
        ...
        (n =
          (n =
            !(n = e.getComputedStyle ? e.getComputedStyle(r, null) : n) &&
            r.currentStyle
              ? r.currentStyle
              : n) || r.style));
    return (
          ...
          void 0 !== p &&
            ...
            (b(a[d]) && b(r[d])
              ? r[d].__swiper__
                ...
                : q(a[d], r[d])
              : !b(a[d]) && b(r[d])
              ? ((a[d] = {}), r[d].__swiper__ ? (a[d] = r[d]) : q(a[d], r[d]))
              : (a[d] = r[d]));
        }
    }
    return a;
    ...
    return (
      e &&
        Object.keys(s).forEach(function (e) {
          ...
          i[e] ||
            !0 !== i.auto ||
            (((t = r.createElement("div")).className = s[e]),
            a.append(t),
            (i[e] = t));
        }),
      i
    ...
    return (
      ...
      m ||
        ...
        !e &&
          ...
          (s = !1)),
        d && !p && ((n.os = "android"), (n.android = !0)),
        (e || a || t) && ((n.os = "ios"), (n.ios = !0)),
        (m = n)),
      m
    );
  }
  ...
  Object.keys(v).forEach(function (e) {
    Object.defineProperty(T.fn, e, { value: v[e], writable: !0 });
  });
  var I = {
      name: "resize",
      create: function () {
      ...
      on: {
        init: function (e) {
          var t = w();
          e.params.resizeObserver && void 0 !== w().ResizeObserver
    ...
    H = {
      ...
      update: {
        ...
        updateSlides: function () {
          ...
          var i = t.params,
            ...
            n = t.rtlTranslate,
            o = t.wrongRTL,
            l = ((b = t.virtual && i.virtual.enabled) ? t.virtual : t).slides
              .length,
            d = s.children("." + t.params.slideClass),
            p = (b ? t.virtual.slides : d).length,
            c = [],
            u = [],
            h = [],
          ...
          if (void 0 !== r) {
              ...
              1 < i.slidesPerColumn &&
                ...
                "row" === i.slidesPerColumnFill && 1 < i.slidesPerGroup
                  ? ((B = Math.floor(
                    ...
                    (A = L - i.slidesPerColumn * i.slidesPerGroup * B),
                    (D =
                      0 === B
                        ? i.slidesPerGroup
                        : Math.min(
                            Math.ceil((p - B * k * i.slidesPerGroup) / k),
                            i.slidesPerGroup
                          )),
                    (H =
                      A - (_ = Math.floor(A / D)) * D + B * i.slidesPerGroup),
                    F.css({
                      "-webkit-box-ordinal-group": (N = H + (_ * v) / k),
                  ...
                  ? ((_ = L - (H = Math.floor(L / k)) * k),
                    (I < H || (H === I && _ === k - 1)) &&
                      k <= (_ += 1) &&
                      ((_ = 0), (H += 1)))
                  : (H = L - (_ = Math.floor(L / P)) * P),
                F.css(
                  a("margin-top"),
                ...
                "none" !== F.css("display") &&
                  ("auto" === i.slidesPerView
                    ? ((G = getComputedStyle(F[0])),
                      ($ = F[0].style.transform),
                      (O = F[0].style.webkitTransform),
                      $ && (F[0].style.transform = "none"),
                      O && (F[0].style.webkitTransform = "none"),
                      (R = i.roundLengths
                        ? t.isHorizontal()
                          ? F.outerWidth(!0)
                          : F.outerHeight(!0)
                        : ((A = e(G, "width")),
                          ...
                          "border-box" === _
                            ? A + N + H
                            : ((_ = (G = F[0]).clientWidth),
                              A + D + B + N + H + (G.offsetWidth - _)))),
                      $ && (F[0].style.transform = $),
                      O && (F[0].style.webkitTransform = O),
                      i.roundLengths && (R = Math.floor(R)))
                    : ((R = (r - (i.slidesPerView - 1) * y) / i.slidesPerView),
                      i.roundLengths && (R = Math.floor(R)),
                      d[L] && (d[L].style[a("width")] = R + "px")),
            ...
            if (
              ...
              if (
                ((t.virtualSize = (R + i.spaceBetween) * v),
                (t.virtualSize =
                ...
                for (var W = [], X = 0; X < c.length; X += 1) {
                  var Y = c[X];
                  i.roundLengths && (Y = Math.floor(Y)),
                    c[X] < t.virtualSize + c[0] && W.push(Y);
                }
                c = W;
              }
            if (!i.centeredSlides) {
              ...
              for (var V = 0; V < c.length; V += 1) {
                ...
                i.roundLengths && (j = Math.floor(j)),
                  c[V] <= t.virtualSize - r && W.push(j);
              }
              (c = W),
                1 <
                  Math.floor(t.virtualSize - r) - Math.floor(c[c.length - 1]) &&
                  c.push(t.virtualSize - r);
            }
            0 === c.length && (c = [0]),
              0 !== i.spaceBetween &&
                ((C = t.isHorizontal() && n ? "marginLeft" : a("marginRight")),
                d
                  .filter(function (e, t) {
              ...
              i.centeredSlides &&
                ...
                (S = (T -= i.spaceBetween) - r),
                (c = c.map(function (e) {
                  return e < 0 ? -m : S < e ? S + f : e;
                }))),
        ...
        updateAutoHeight: function (e) {
          ...
          else s.push(o(i.activeIndex));
          for (t = 0; t < s.length; t += 1)
            void 0 !== s[t] && (n = n < (a = s[t].offsetHeight) ? a : n);
        ...
        updateProgress: function (e) {
          ...
          q(t, { progress: s, isBeginning: r, isEnd: l }),
        ...
        updateSlidesClasses: function () {
          ...
          t.removeClass(
            ...
            a.loop &&
              0 === r.length &&
              (r = t.eq(0)).addClass(a.slideNextClass),
            (s = s
      ...
      slide: {
        slideTo: function (e, t, a, i, s) {
          ...
          if (
            ...
            return !1;
          (s = Math.min(n.params.slidesPerGroupSkip, o)),
            (s += Math.floor((o - s) / n.params.slidesPerGroup)) >= d.length &&
              (s = d.length - 1),
        ...
        loopCreate: function () {
          ...
          if (t.loopFillGroupWithBlank) {
            ...
            if (r !== t.slidesPerGroup) {
              for (var n = 0; n < r; n += 1) {
                var o = T(e.createElement("div")).addClass(
          ...
          for (var p = 0; p < d.length; p += 1)
            a.append(T(d[p].cloneNode(!0)).addClass(t.slideDuplicateClass));
          for (var c = l.length - 1; 0 <= c; --c)
            a.prepend(T(l[c].cloneNode(!0)).addClass(t.slideDuplicateClass));
        },
        loopFix: function () {
          var e = this;
        ...
        attachEvents: function () {
          ...
          (e.onTouchStart = function (e) {
            ...
            if (o && (!t.animating || !r.preventInteractionOnTransition)) {
              var l = e,
                d = T((l = l.originalEvent ? l.originalEvent : l).target);
              if (
                ...
                !!r.noSwipingClass &&
                  ...
                  e.path[0] &&
                  (d = T(e.path[0]));
                var p = r.noSwipingSelector || "." + r.noSwipingClass,
                  c = !(!l.target || !l.target.shadowRoot);
                if (r.noSwiping && (c ? O(p, l.target) : d.closest(p)[0]))
                  t.allowClick = !0;
                else if (!r.swipeHandler || d.closest(r.swipeHandler)[0]) {
                  (n.currentX = (
                    "touchstart" === l.type ? l.targetTouches[0] : l
                  ).pageX),
                    (n.currentY = (
                      "touchstart" === l.type ? l.targetTouches[0] : l
                    ).pageY);
                  ...
                  q(s, {
                    ...
                    "touchstart" !== l.type &&
                      ((o = !0),
                      d.is(s.focusableElements) && (o = !1),
                      a.activeElement &&
                        T(a.activeElement).is(s.focusableElements) &&
                        a.activeElement !== d[0] &&
                        a.activeElement.blur(),
                      (o = o && t.allowTouchMove && r.touchStartPreventDefault),
                        ...
                        if (
                              ...
                              ? ((e = !1),
                                s.resistance &&
                                  (i.currentTranslate =
                                    ...
                                    1 +
                                    Math.pow(
                                      -a.minTranslate() + i.startTranslate + t,
                                      n
                                    )))
                              : t < 0 &&
                                ...
                                s.resistance &&
                                  (i.currentTranslate =
                                    ...
                                    1 -
                                    Math.pow(
                                      a.maxTranslate() - i.startTranslate - t,
                                      n
                                    ))),
                          ...
                          s.followFinger &&
                            ...
                            s.freeMode &&
                              ...
                              i.velocities.push({
                                position:
                                  r[a.isHorizontal() ? "currentX" : "currentY"],
                                time: M(),
                              })),
              ...
              if (t.enabled) {
                ...
                if (
                  ...
                  if (i.freeMode)
                    ...
                    for (
                      var w = 0, E = t.slidesSizesGrid[0], x = 0;
                      x < o.length;
                      x += x < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup
                    ) {
                      var C =
                        x < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
                      void 0 !== o[x + C]
                        ? p >= o[x] &&
                          p < o[x + C] &&
                          (E = o[(w = x) + C] - o[x])
                        : p >= o[x] &&
                          ((w = x), (E = o[o.length - 1] - o[o.length - 2]));
                    }
                    (g = (p - o[w]) / E),
                      (u = w < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup);
                    e > i.longSwipesMs
                      ? i.longSwipes
                        ? ("next" === t.swipeDirection &&
                            (g >= i.longSwipesRatio
                      ...
                      ? t.navigation &&
                        ...
                        ? d.target === t.navigation.nextEl
                          ? t.slideTo(w + u)
                          : t.slideTo(w)
                        : ("next" === t.swipeDirection && t.slideTo(w + u),
          ...
          !o.touch && o.pointerEvents
            ...
            : (o.touch &&
                ...
                D || (t.addEventListener("touchstart", B), (D = !0))),
          ...
          !c ||
            ...
            ((e = s.getBreakpoint(c, s.params.breakpointsBase, s.el)) &&
              ...
              d &&
                ...
                s.loopCreate(),
                s.updateSlides(),
                s.slideTo(r - l + s.loopedSlides, 0, !1)),
              s.emit("breakpoint", t)));
        },
      ...
      images: {
        loadImage: function (e, t, a, i, s, r) {
          ...
          !(T(e).parent("picture")[0] || (e.complete && s)) && t
            ? (((n = new n.Image()).onload = o),
              (n.onerror = o),
              i && (n.sizes = i),
              a && (n.srcset = a),
              t && (n.src = t))
    ...
    _ = (function () {
      function l() {
        ...
        if (
          ...
          n && !a.el && (a.el = n),
          a.el && 1 < T(a.el).length)
        ) {
          var s = [];
          return (
            T(a.el).each(function (e) {
              e = q({}, a, { el: e });
              s.push(new l(e));
            }),
            s
        ...
        (r.__swiper__ = !0),
          (r.support = z()),
          (r.device = k({ userAgent: a.userAgent })),
          (r.browser = P()),
          (r.eventsListeners = {}),
          ...
          Object.keys(r.modules).forEach(function (e) {
            ...
            t.params &&
              ...
              "object" == typeof (t = t.params[e]) &&
                null !== t &&
                (0 <= ["navigation", "pagination", "scrollbar"].indexOf(e) &&
                  !0 === a[e] &&
                  (a[e] = { auto: !0 }),
                e in a &&
                  "enabled" in t &&
      ...
      return (
          ...
          var s,
            r = (function () {
              if (t && t.shadowRoot && t.shadowRoot.querySelector) {
                var e = T(t.shadowRoot.querySelector(i()));
                return (
        ...
        (l.installModule = function (e) {
          ...
          var t = e.name || Object.keys(l.prototype.modules).length + "_" + M();
  ...
  var R = {
      update: function (e) {
        ...
        var n = t.activeIndex || 0,
          ...
          o = r
            ? ((g = Math.floor(i / 2) + s + l), Math.floor(i / 2) + s + o)
            : ((g = i + (s - 1) + l), s + o),
          f = Math.max((n || 0) - o, 0),
    ...
    F = {
      ...
      create: function () {
        E(this, {
          virtual: e({}, R, { slides: this.params.virtual.slides, cache: {} }),
        });
      },
      on: {
      ...
      handle: function (e) {
        ...
        if (t.enabled) {
          var a = w(),
            ...
            r = e,
            n =
              (r = r.originalEvent ? r.originalEvent : r).keyCode || r.charCode,
          ...
          if (
            !t.allowSlideNext &&
            ((t.isHorizontal() && c) || (t.isVertical() && e) || d)
          )
            return !1;
          if (
            !t.allowSlidePrev &&
  ...
  var Y = {
      ...
      event: function () {
        var e, t, a, i;
        return -1 < w().navigator.userAgent.indexOf("firefox")
          ? "DOMMouseScroll"
          : ((t = y()),
            (i = (a = "onwheel") in t) ||
        ...
        if (a.enabled) {
          ...
          if (
            ("container" !== a.params.mousewheel.eventsTarget &&
              (s = T(a.params.mousewheel.eventsTarget)),
          ...
          if (
            ...
            if (!n) {
              ...
              if (
                ...
                a.updateActiveIndex(),
                a.updateSlidesClasses(),
                ((!s && a.isBeginning) || (!i && a.isEnd)) &&
                  a.updateSlidesClasses(),
                a.params.freeModeSticky &&
                  (clearTimeout(a.mousewheel.timeout),
                  (a.mousewheel.timeout = void 0),
                  15 <= (l = a.mousewheel.recentWheelEvents).length &&
                    l.shift(),
        ...
        return (
          (a =
            "container" !== e.params.mousewheel.eventsTarget
              ? T(e.params.mousewheel.eventsTarget)
        ...
        a.params.loop ||
          ...
          (t = t.$prevEl) &&
            ...
            a.params.watchOverflow &&
              a.enabled &&
              t[a.isLocked ? "addClass" : "removeClass"](i.lockClass)),
          e &&
            0 < e.length &&
            (a.isEnd ? s(e, !0) : s(e, !1),
            a.params.watchOverflow &&
    ...
    U = {
      update: function () {
        ...
        if (
          ...
          if (
            ...
            if (
              (a.dynamicBullets &&
                ...
                (d =
                  ((l = o + (Math.min(u.length, a.dynamicMainBullets) - 1)) +
                    o) /
                  2)),
              u.removeClass(
                a.bulletActiveClass +
              ...
              if ((h.addClass(a.bulletActiveClass), a.dynamicBullets)) {
                ...
                if (e.params.loop)
                  if (m >= u.length - a.dynamicMainBullets) {
                    ...
                    u.eq(u.length - a.dynamicMainBullets - 1).addClass(
          ...
          "fraction" === a.type &&
            (r.find(x(a.currentClass)).text(a.formatFractionCurrent(i + 1)),
            r.find(x(a.totalClass)).text(a.formatFractionTotal(n))),
            "progressbar" === a.type &&
            ...
            for (var n = 0; n < r; n += 1)
              t.renderBullet
                ...
                : (s +=
                    ...
                    t.bulletElement +
                    ">");
            i.html(s), (e.pagination.bullets = i.find(x(t.bulletClass)));
          }
          "fraction" === t.type &&
            ((s = t.renderFraction
      ...
      init: function () {
        ...
        !a.el ||
          (0 !== (e = T(a.el)).length &&
            ...
            a.clickable &&
              e.on("click", x(a.bulletClass), function (e) {
                e.preventDefault();
      ...
      destroy: function () {
        ...
        a.el &&
          ...
          a.clickable && e.off("click", x(a.bulletClass)));
      },
    },
    K = {
      name: "pagination",
      ...
      create: function () {
        E(this, { pagination: e({ dynamicBulletIndex: 0 }, U) });
      },
      on: {
        init: function (e) {
        ...
        click: function (e, t) {
          ...
          e.params.pagination.el &&
            ...
            0 < e.pagination.$el.length &&
            !T(t).hasClass(e.params.pagination.bulletClass) &&
            ((e.navigation &&
    ...
    Z = {
      ...
      updateSize: function () {
        ...
        o.params.scrollbar.el &&
          ...
          q(e, { trackSize: i, divider: s, moveDivider: r, dragSize: n }),
      ...
      init: function () {
        var e = this,
          t = e.scrollbar,
          a = e.$el;
        e.params.scrollbar = C(a, e.params.scrollbar, e.params.createElements, {
          el: "swiper-scrollbar",
        });
        var i,
        ...
        s.el &&
          ...
          0 ===
            ...
            i.append(a)),
          q(t, { $el: i, el: i[0], $dragEl: a, dragEl: a[0] }),
    ...
    Q = {
      ...
      create: function () {
        E(this, {
          scrollbar: e({ isTouched: !1, timeout: null, dragTimeout: null }, Z),
        });
      },
      on: {
        init: function (e) {
    ...
    te = {
      ...
      onGestureStart: function (e) {
        ...
        ((r.$slideEl = T(e.target).closest("." + t.params.slideClass)),
      ...
      in: function (e) {
        ...
        l.$slideEl ||
          (e &&
            e.target &&
            (l.$slideEl = T(e.target).closest("." + s.params.slideClass)),
          l.$slideEl ||
          ...
          l.$imageEl &&
            ...
            e
              ? ((o = l.$slideEl[0].offsetWidth),
                ...
                (r = r * n.scale),
                (d = d * n.scale),
                (r = Math.min(o / 2 - r / 2, 0)),
                (e = Math.min(e / 2 - d / 2, 0)),
                (d = -r) < (a = (a = a * n.scale) < r ? r : a) && (a = d),
                (d = -e) < (i = (i = i * n.scale) < e ? e : i) && (i = d))
              : (i = a = 0),
            l.$imageWrapEl
              .transition(300)
        ...
        if (t && !t.destroyed) {
          ...
          n
            ...
            : t.lazy.scrollHandlerAttached ||
              ...
              a.on("scroll", t.lazy.checkInViewOnLoad, e));
        }
      },
    },
    se = {
      ...
      create: function () {
        E(this, { lazy: e({ initialImageLoaded: !1 }, ie) });
      },
      on: {
        beforeInit: function (e) {
    ...
    ne = {
      ...
      create: function () {
        E(this, {
          controller: e({ control: this.params.controller.control }, re),
        });
      },
      on: {
        update: function (e) {
    ...
    oe = {
      ...
      onEnterOrSpaceKey: function (e) {
        ...
        (13 !== e.keyCode && 32 !== e.keyCode) ||
          ...
          t.pagination &&
            e.is(x(t.params.pagination.bulletClass)) &&
            e[0].click());
      },
      notify: function (e) {
      ...
      init: function () {
        ...
        a.a11y.addElId(t, s),
          ...
          a.a11y.addElRole(T(a.slides), i.slideRole);
        var r,
          n,
          o = (
            a.params.loop
        ...
        a.slides.each(function (e, t) {
          ...
          a.pagination &&
            ...
            a.pagination.$el.on(
              "keydown",
              x(a.params.pagination.bulletClass),
    ...
    de = {
      init: function () {
        ...
        if (e.params.history) {
          ...
          var a = e.history;
          (a.initialized = !0),
            (a.paths = de.getPathValues(e.params.url)),
      ...
      setHistory: function (e, t) {
        ...
        s.history.initialized &&
          ...
          (i = s.slides.eq(t)),
          (t = de.slugify(i.attr("data-history"))),
          0 < s.params.history.root.length
            ? (t =
                (i =
                  "/" === (i = s.params.history.root)[i.length - 1]
      ...
      scrollToSlide: function (e, t, a) {
        ...
        if (t)
          for (var s = 0, r = i.slides.length; s < r; s += 1) {
            var n = i.slides.eq(s);
            de.slugify(n.attr("data-history")) !== t ||
      ...
      init: function () {
        ...
        if (
          ...
          e.params.hashNavigation.watchState &&
            T(a).on("hashchange", e.hashNavigation.onHashChange);
        }
      },
      destroy: function () {
        var e = w();
        this.params.hashNavigation.watchState &&
          T(e).off("hashchange", this.hashNavigation.onHashChange);
      },
    },
    ue = {
      ...
      create: function () {
        E(this, { hashNavigation: e({ initialized: !1 }, ce) });
      },
      on: {
        init: function (e) {
    ...
    me = {
      ...
      create: function () {
        E(this, { autoplay: e({}, he, { running: !1, paused: !1 }) });
      },
      on: {
        init: function (e) {
        ...
        p.shadow &&
          (c
            ...
            : 0 === (e = a.find(".swiper-cube-shadow")).length &&
              ((e = T('<div class="swiper-cube-shadow"></div>')), a.append(e)));
        for (var m, f = 0; f < s.length; f += 1) {
          var v = s.eq(f),
            g = f,
            b =
              90 *
              (g = u ? parseInt(v.attr("data-swiper-slide-index"), 10) : g),
            y = Math.floor(b / 360);
        ...
        return (
          t.swiper instanceof a
            ? ((e.thumbs.swiper = t.swiper),
              q(e.thumbs.swiper.originalParams, {
                watchSlidesProgress: !0,
                slideToClickedSlide: !1,
              }),
        ...
        s &&
          ...
          ((e = s.clickedSlide) &&
            ...
            (null != t &&
              ((a = s.params.loop
                ? parseInt(
                    T(s.clickedSlide).attr("data-swiper-slide-index"),
                    10
                  )
                : t),
              i.params.loop &&
    ...
    $ = {
      ...
      create: function () {
        E(this, { thumbs: e({ swiper: null, initialized: !1 }, xe) });
      },
      on: {
        beforeInit: function (e) {
  ...
  (function (e) {
    ...
    function c(e, t, a, i) {
      ...
      return (
        (s.className = "mfp-" + e),
        a && (s.innerHTML = a),
        i ? t && t.appendChild(s) : ((s = d(s)), t && s.appendTo(t)),
        s
      );
    }
    function u(e, t) {
      m.ev.triggerHandler("mfp" + e, t),
        m.st.callbacks &&
          ...
          m.st.callbacks[e] &&
            m.st.callbacks[e].apply(m, d.isArray(t) ? t : [t]));
    }
    function h(e) {
      return (
        (e === t && m.currTemplate.closeBtn) ||
          ((m.currTemplate.closeBtn = d(
    ...
    function r() {
      d.magnificPopup.instance ||
        ((m = new e()).init(), (d.magnificPopup.instance = m));
    }
    var m,
      i,
      f,
    ...
    (e.prototype = {
      ...
      open: function (e) {
        if (!1 === e.isObj) {
          ...
          for (var t, a = e.items, i = 0; i < a.length; i++)
            if ((t = (t = a[i]).parsed ? t.el[0] : t) === e.el[0]) {
              m.index = i;
              break;
            }
        } else
          (m.items = d.isArray(e.items) ? e.items : [e.items]),
            (m.index = e.index || 0);
        if (!m.isOpen) {
          (m.types = []),
            (v = ""),
            ...
            e.key
              ...
              : (m.currTemplate = {}),
            (m.st = d.extend(!0, {}, d.magnificPopup.defaults, e)),
            (m.fixedContentPos =
            ...
            m.bgOverlay ||
              ((m.bgOverlay = c("bg").on("click" + w, function () {
                m.close();
              })),
              (m.wrap = c("wrap")
                .attr("tabindex", -1)
          ...
          u("BeforeOpen"),
            m.st.showCloseBtn &&
              (m.st.closeBtnInside
                ? (p(b, function (e, t, a, i) {
                    a.close_replaceWith = h(i.type);
                  }),
                  (v += " mfp-close-btn-in"))
                : m.wrap.append(h())),
            ...
            m.fixedContentPos
              ...
              : m.wrap.css({ top: x.scrollTop(), position: "absolute" }),
            (!1 !== m.st.fixedBgPos &&
              ("auto" !== m.st.fixedBgPos || m.fixedContentPos)) ||
              m.bgOverlay.css({ height: f.height(), position: "absolute" }),
            m.st.enableEscapeKey &&
              f.on("keyup" + w, function (e) {
          ...
          m.fixedContentPos &&
            (!m._hasScrollBar(n) ||
              ((l = m._getScrollbarSize()) && (o.marginRight = l))),
            m.fixedContentPos &&
              (m.isIE7
          ...
          return (
            ...
            m.bgOverlay
              .add(m.wrap)
              .prependTo(m.st.prependTo || d(document.body)),
            (m._lastFocusedEl = document.activeElement),
            setTimeout(function () {
              m.content
                ? (m._addClassToMFP(E), m._setFocus())
                : m.bgOverlay.addClass(E),
                f.on("focusin" + w, m._onFocusIn);
            }, 16),
            (m.isOpen = !0),
            m.updateSize(n),
            u(y),
      ...
      updateItemHTML: function () {
        ...
        u("BeforeChange", [m.currItem ? m.currItem.type : "", t]),
          ...
          m.currTemplate[t] ||
            ...
            u("FirstMarkupParse", a),
            (m.currTemplate[t] = !a || d(a))),
          s && s !== e.type && m.container.removeClass("mfp-" + s + "-holder");
        var a = m["get" + t.charAt(0).toUpperCase() + t.slice(1)](
          e,
          m.currTemplate[t]
        );
        m.appendContent(a, t),
      ...
      parseEl: function (e) {
        ...
        if (
          (a = a.tagName
            ? { el: d(a) }
            : ((t = a.type), { data: a, src: a.src })).el
        ) {
          for (var i = m.types, s = 0; s < i.length; s++)
      ...
      addGroup: function (t, a) {
        function e(e) {
          (e.mfpEl = this), m._openClick(e, t, a);
        }
        var i = "click.magnificPopup";
        ((a = a || {}).mainEl = t),
          a.items
            ? ((a.isObj = !0), t.off(i).on(i, e))
            : ((a.isObj = !1),
              a.delegate
                ? t.off(i).on(i, a.delegate, e)
                : (a.items = t).off(i).on(i, e));
      },
      _openClick: function (e, t, a) {
        if (
          (void 0 !== a.midClick ? a : d.magnificPopup.defaults).midClick ||
          !(2 === e.which || e.ctrlKey || e.metaKey || e.altKey || e.shiftKey)
        ) {
          var i = (void 0 !== a.disableOn ? a : d.magnificPopup.defaults)
            .disableOn;
          if (i)
            if (d.isFunction(i)) {
          ...
          e.type && (e.preventDefault(), m.isOpen && e.stopPropagation()),
            (a.el = d(e.mfpEl)),
            a.delegate && (a.items = t.find(a.delegate)),
            m.open(a);
        }
      },
      ...
      _checkIfClose: function (e) {
        if (!d(e).hasClass(n)) {
          var t = m.st.closeOnContentClick,
            a = m.st.closeOnBgClick;
          if (t && a) return !0;
          if (
            !m.content ||
            d(e).hasClass("mfp-close") ||
      ...
      _hasScrollBar: function (e) {
        return (
          (m.isIE7 ? f.height() : document.body.scrollHeight) >
          (e || x.height())
        );
      },
      _setFocus: function () {
      ...
      _onFocusIn: function (e) {
        if (e.target !== m.wrap[0] && !d.contains(m.wrap[0], e.target))
          ...
          d.each(e, function (e, t) {
            return (
              ...
              void (1 < (r = e.split("_")).length
                ? 0 < (a = s.find(w + "-" + r[0])).length &&
                  ("replaceWith" === (i = r[1])
                    ? a[0] !== t[0] && a.replaceWith(t)
                    : "img" === i
                    ? a.is("img")
                      ? a.attr("src", t)
                      : a.replaceWith(
      ...
      (d.fn.magnificPopup = function (e) {
        ...
        return (
          "string" == typeof e
            ? "open" === e
              ? ((t = o ? s.data("magnificPopup") : s[0].magnificPopup),
                (a = parseInt(arguments[1], 10) || 0),
                (i = t.items
                  ? t.items[a]
                  : ((i = s), (i = t.delegate ? i.find(t.delegate) : i).eq(a))),
                m._openClick({ mfpEl: i }, s, t))
              : m.isOpen &&
                m[e].apply(m, Array.prototype.slice.call(arguments, 1))
            : ((e = d.extend(!0, {}, e)),
              o ? s.data("magnificPopup", e) : (s[0].magnificPopup = e),
              m.addGroup(s, e)),
          s
        );
      });
    function C() {
      M && (S.after(M.addClass(T)).detach(), (M = null));
    }
    var T,
      S,
      M,
          ...
          if ((C(), e.src)) {
            ...
            return (
              s.length
                ? ((a = s[0].parentNode) &&
                    a.tagName &&
                    (S || ((T = i.hiddenClass), (S = c(T)), (T = "mfp-" + T)),
                    (M = s.after(S).detach().removeClass(T))),
                  m.updateStatus("ready"))
                : (m.updateStatus("error", i.tNotFound), (s = d("<div>"))),
              (e.inlineElement = s)
            );
          }
          ...
          m.types.push("image"),
            p(y + t, function () {
              "image" === m.currItem.type &&
                e.cursor &&
                d(document.body).addClass(e.cursor);
            }),
            p(l + t, function () {
              e.cursor && d(document.body).removeClass(e.cursor),
                x.off("resize" + w);
            }),
            p("Resize" + t, m.resizeImage),
            m.isLowIE && p("AfterChange", m.resizeImage);
        },
        ...
        getImage: function (e, t) {
          ...
          function i() {
            e &&
              ...
              e === m.currItem &&
                (m._onImageHasSize(e),
                m.updateStatus("error", n.tError.replace("%url%", e.src))),
              (e.hasSize = !0),
              (e.loaded = !0),
              (e.loadError = !0));
          }
          ...
          return (
            o.length &&
              ...
              (e.img = d(s).on("load.mfploader", a).on("error.mfploader", i)),
              (s.src = e.src),
    ...
    d.magnificPopup.registerModule("zoom", {
      ...
      proto: {
          ...
          n.enabled &&
            ...
            (a = function (e) {
              var t = e
                ...
                e = "transition";
              return (
                (i["-webkit-" + e] = i["-moz-" + e] = i["-o-" + e] = i[e] = a),
                t.css(i),
                t
              );
            }),
        ...
        _getOffset: function (e) {
          ...
          a.top -= d(window).scrollTop() - i;
          i = {
            width: t.width(),
            height: (o ? t.innerHeight() : t[0].offsetHeight) - e - i,
          };
          return (
            (O =
              void 0 === O
    ...
    function A(e) {
      var t;
      !m.currTemplate[D] ||
        ((t = m.currTemplate[D].find("iframe")).length &&
    ...
    d.magnificPopup.registerModule("gallery", {
      ...
      proto: {
        initGallery: function () {
          ...
          (v += " mfp-gallery"),
            ...
            p("UpdateStatus" + e, function (e, t) {
              t.text && (t.text = N(t.text, m.currItem.index, m.items.length));
            }),
            p(b + e, function (e, t, a, i) {
              var s = m.items.length;
              a.counter = 1 < s ? N(r.tCounter, i.index, s) : "";
            }),
        ...
        next: function () {
          (m.direction = !0), (m.index = B(m.index + 1)), m.updateItemHTML();
        },
        prev: function () {
          (m.direction = !1), (m.index = B(m.index - 1)), m.updateItemHTML();
        },
        goTo: function (e) {
        ...
        preloadNearbyImages: function () {
          for (
            var e = m.st.gallery.preload,
              ...
              a = Math.min(e[1], m.items.length),
              i = 1;
            i <= (m.direction ? a : t);
            i++
          )
            m._preloadItem(m.index + i);
          for (i = 1; i <= (m.direction ? t : a); i++)
            m._preloadItem(m.index - i);
        },
      ...
      proto: {
        initRetina: function () {
          ...
          1 < window.devicePixelRatio &&
            ...
            (i = a.ratio),
            1 < (i = isNaN(i) ? i() : i) &&
              (p("ImageHasSize." + H, function (e, t) {
                t.img.css({
                  "max-width": t.img[0].naturalWidth / i,
                  width: "100%",
                });
              }),
              p("ElementParse." + H, function (e, t) {
                t.src = a.replaceSrc(t, i);
              })));
        },
      },
    }),
